...
#additions for SPF inverters
#The following are missing and need to be researched
#the icon's also need to be checked
#x      "op_va":0,
#x      "loadpercent":0,
#x      "buck1_ntc":0,
#x      "buck2_ntc":0,
...
#x      "BatWatt":-5880
  ...
  {
    "name": "Inverter Consumption Power",
    "device_class": SensorDeviceClass.POWER,
    "unit_of_measurement": UnitOfPower.WATT,
    "state_class": SensorStateClass.MEASUREMENT,
    "icon": "mdi:home-lightning-bolt",
    "func": lambda js: js['values']["op_watt"],
    "divider": 10,
...
#     "device_class": SensorDeviceClass.POWER,
#     "unit_of_measurement": UnitOfPower.WATT, #Not sure if this is the correct one for this
#     "state_class": SensorStateClass.MEASUREMENT,
#     "icon": "mdi:home-lightning-bolt",
#     "func": lambda js: js['values']["op_va"],
#     "divider": 10,
#     "unique_name": "mqtt_111",
#   },
  {
    "name": "Storage charging grid",
    "device_class": SensorDeviceClass.POWER,
    "unit_of_measurement": UnitOfPower.WATT,
    "state_class": SensorStateClass.MEASUREMENT,
    "icon": "mdi:home-lightning-bolt",
...
#   {
#     "name": "Storage charging grid reactive power",
#     "device_class": SensorDeviceClass.POWER,
#     "unit_of_measurement": UnitOfPower.WATT, #Not sure if this is the correct one for this
#     "state_class": SensorStateClass.MEASUREMENT,
#     "icon": "mdi:home-lightning-bolt",
...
#   },
  ...
  },
 {
  ...
  },
  {
    ...
    "entity_category": EntityCategory.DIAGNOSTIC,
    "icon": "mdi:thermometer",
    "func": lambda js: js['values']["dcdctemp"],
    "divider": 10,
  ...
  },
  {
    ...
    "state_class": SensorStateClass.TOTAL_INCREASING,
    "icon": "mdi:solar-power",
    "func": lambda js: js['values']["epvtoday"],
    "divider": 10,
    "unique_name": "mqtt_126",
  },
  {
    "name": "Battery Charged from AC - Today",
    "device_class": SensorDeviceClass.ENERGY,
    "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR,
    "state_class": SensorStateClass.TOTAL_INCREASING,
    "icon": "mdi:battery-arrow-up",
    ...
    {
    "name": "Battery Charged from AC - Total",
    "device_class": SensorDeviceClass.ENERGY,
    "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR,
    "state_class": SensorStateClass.TOTAL,
    "icon": "mdi:battery-arrow-up",
